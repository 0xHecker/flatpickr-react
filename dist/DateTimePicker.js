...
const DateTimePicker = (_a) => {
  var { defaultValue = '', options = {}, value, children, className, render } = _a,
    props = __rest(_a, ['defaultValue', 'options', 'value', 'children', 'className', 'render']);
      ...
      optionsKeys.forEach((key) => {
        ...
        if (flatpickrInstance.current && flatpickrInstance.current.config) {
          if (value !== flatpickrInstance.current.config[key]) {
            if (Array.from(hooks).includes(key) && !Array.isArray(value)) {
              if (value !== undefined) {
                value = [value];
              }
            }
  ...
  if (render) {
    return render(
      Object.assign(Object.assign({}, filteredProps), { defaultValue, value }),
      handleNodeChange,
  ...
  return _jsx(
    ...
    Object.assign({}, filteredProps, {
      ...
      value: value !== undefined ? formatValue(value, options.dateFormat) : undefined,
    })
  );
};
